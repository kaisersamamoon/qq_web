<template>
  <div class="layout-cmp__aside">
    ...
    <div class="nav-list">
      <router-link to="/chat/home" tag="span" title="主页">
        <div class="nav-item-f">
          <span class="nav-item iconfont chat-chat"></span>
          <p class="nav-item item-text">主页</p>
        </div>
      </router-link>
      <router-link to="/chat/add" tag="span" title="加好友">
        <div class="nav-item-f">
          <span class="nav-item iconfont chat-man-add"></span>
          <p class="nav-item item-text">加好友</p>
        </div>
      </router-link>
      <router-link to="/chat/mzone" tag="span" title="空间">
        <div class="nav-item-f">
          <span class="nav-item iconfont chat-moment"></span>
          <p class="nav-item item-text">空间</p>
        </div>
      </router-link>
...
@import './../../../../static/chat-font/iconfont.css';
